...
| U06e | Group panel (5 member HP bars) | done | |
| U06f | Pet panel (HP bar + command buttons) | done | |
| U06g | Spellbook popup | done | |
| U06h | Skills popup | done | |
...
| U07c1 | Disable old UI render + input (new UI takes over) | pending | |
